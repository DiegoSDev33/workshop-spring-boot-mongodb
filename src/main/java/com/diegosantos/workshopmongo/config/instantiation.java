...
public class instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null,sdf.parse("23/03/2024") , "Bom dia", "Acordei feliz hoje!", new AuthorDTO(tiago));
		
		CommentDTO c1 = new CommentDTO("Boa Viagem mano!!", sdf.parse("21/0/2018"), new AuthorDTO(jessica));
		CommentDTO c2 = new CommentDTO("Aproveite Bastante ", sdf.parse("22/03/2018"), new AuthorDTO(juliana));
		CommentDTO c3 = new CommentDTO("Tenha um otimo dia!", sdf.parse("23/04/2024"), new AuthorDTO(jessica));
